...
\end{flalign}
where $\alpha$ and $\zeta_\text{Chl}$ are model parameters (initial Chl-specific slope of P-I curve and cost of chlorophyll synthesis, respectively, Table~3 in K21-N) and $L_\text{D}$ is fractional day length (Eq.~21 in K21-N). %  $\hat{\theta}$ is the optimal chlorophyll density in the chloroplast.\\
...
%4)Probably we should have considered $\frac{\partial{\hat{\theta}}}{\partial{\bar{I}}}$ as well, since $\hat{\theta} = f(\bar{I}$ (Eq.~26 in K21-N), but it appears as if it wasn't in S16 either (Eq.~A-4)}\\
...
\begin{figure}[ht!]
\includegraphics[width=14cm,trim=0cm 0mm 0.0cm 0mm, clip]{figures/2022-01-03_T10_TheHat03_PARint_vs_PARext/0D-Highlat_wconst_T10_lext_CbasedIA_TheHat03_dm_vs_0D-Highlat_wconst_T10_lint_CbasedIA_TheHat03_dm_cont_abio0_2y.png}
...
\begin{figure}[ht!]
\includegraphics[width=14cm,trim=0cm 9mm 0.0cm 5mm, clip]{figures/2022-01-03_T10_TheHat03_PARint_vs_PARext/0D-Highlat_wconst_T10_lext_CbasedIA_TheHat03_dm_vs_0D-Highlat_wconst_T10_lint_CbasedIA_TheHat03_dm_cont_abio1_2y.png}

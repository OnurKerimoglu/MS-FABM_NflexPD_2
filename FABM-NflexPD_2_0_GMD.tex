...
\begin{flalign}
 ...
 \frac{\partial Z}{\partial \hat{V}} \frac{\hat{V}}{\partial \text{DIN}} &= 
 \frac{-\hat{\mu}_{net} \cdot Q_\text{N,0}}{2 \cdot \hat{V}_\text{N} \cdot \text{DIN}} \left( 1 - \frac{\hat{V}_\text{N}}{\hat{V}_\text{N,0}} - \frac{\hat{V}_\text{N}}{\sqrt{\hat{V}_\text{N,0} \cdot \hat{A}_\text{N,0} \cdot \text{DIN}}} \right) \\
 \frac{\partial Z}{\partial \bar{I}} =
 \frac{\partial Z}{\partial \hat{\mu}_{net}} \frac{\hat{\mu}_{net}}{\partial \bar{I}} &=
 \frac{\partial Z}{\partial \hat{\mu}_{net}} \frac{\hat{\mu}_{net}}{\partial L_I} \frac{\partial L_I}{\bar{I}}=
 \frac{Q_\text{N,0}}{2 \cdot \hat{V}_\text{N}} \left(L_\text{D} \cdot (1-\hat{\theta} \cdot \zeta_\text{Chl}) \right) \left ( -\alpha \cdot \hat{\theta} \cdot (L_\text{I}-1) \right) 
\end{flalign}

...
\end{equation}
The rate of change of $\text{Phy}_{\text{N}}$ resulting from Eqs.~\eqref{eq:sPhyC} --~\eqref{eq:dim}  is the complement of the sum of Eqs.~\eqref{eq:sDetN} and ~\eqref{eq:sdin}:
\begin{equation}
  \label{eq:phyn_def}

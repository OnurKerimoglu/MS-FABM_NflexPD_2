...
\end{flalign}
$\frac{\mathrm{d}\, Z}{\mathrm{d}\, \bar{I}}$ can be then derived as:
\begin{flalign}
 \frac{\mathrm{d}\, Z}{\mathrm{d}\, \bar{I}} &=
 \frac{\mathrm{d}\, Z}{\mathrm{d}\, \hat{\mu}_{net}} \frac{\mathrm{d}\, \hat{\mu}_{net}}{\mathrm{d}\, \bar{I}} =
 \frac{Q_{\text{N,0}}}{2 \cdot \hat{V}_{\text{N}}} \left( \frac{\partial \hat{\mu}_{net}}{\partial\bar{I}}

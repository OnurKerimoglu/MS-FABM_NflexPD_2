...
\end{equation}
here, the first term reflects the N equivalent of the change in $\text{Phy}_{\text{C}}$, i.e., Eq.~\ref{eq:sPhyC}, and the second term describes the effect of the change in quota over time due to imbalances between C and N uptake. Substituting Eq.~\ref{eq:sPhyC} in Eq.~\ref{eq:sPhyN2}:
\begin{equation}
  \label{eq:sPhyN3}
 ...
 \tag{\ref{eq:sPhyN}.3}
\end{equation}
and plugging Eqs.~\ref{eq:growth} and \ref{eq:mortN} into Eq.~\ref{eq:sPhyN3} yields:
\begin{equation}
  \label{eq:sPhyN4}

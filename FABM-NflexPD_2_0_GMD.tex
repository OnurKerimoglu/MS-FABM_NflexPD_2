...
\begin{description}
 ...
 \item [T3] \onur{in progress} demonstration with multiple phytoplanton groups \onur{idea: difference in scaling of model speed vs number of plankton functional types (e.g., 1, 2, 5 pfts) with DA and IA variants, with potentially clearer speed advantages of IA when simulating higher number of pfts)}
 \item [T4] application of the model in an idealisitc 1D setup and assessment of mass conservation \textcolor{red}{\{Onur: this test failed. In 1D, model does not seem to be mass conservative. The question is whether we want to show and discuss these results?\}} 
\end{description}
...
\subsubsection{0D setup (T1-T2)}
    ...
    \begin{figure}[ht!]
    \includegraphics[width=8cm,trim=2.9cm 0mm 20.0cm 0mm, clip]{figures/2022-02-10a_Ld1_T20_ThatVar_PARint_vs_PARext/0D-Highlat_wconst_lext_Ld1_T20_CbasedIA_modular_24h_vs_0D-Highlat_wconst_lint_Ld1_T20_CbasedIA_modular_24h_cont_abio0_1y.png}
...
\begin{figure}[ht!]
\includegraphics[width=12cm,trim=0cm 16.8cm 0.0cm 5mm, clip]{figures/2022-02-10a_Ld1_T20_ThatVar_PARint_vs_PARext/0D-Highlat_wconst_lext_Ld1_T20_CbasedIA_modular_24h_vs_0D-Highlat_wconst_lint_Ld1_T20_CbasedIA_modular_24h_cont_abio1_1y.png}
...
\setlength{\unitlength}{1mm}
  ...
  %\put(0,0){\tiny \grid(80,50)(5,5)[0,0]}
  \end{picture}
  \caption{Daily average irradiance and its temporal derivative, as extracted from the simulation outputs generated for T1. PAR:N (solid blue line) is the model version where the temporal derivative of irradiance is approximated numerically; PAR:A (dashed orange line): both irradiance and its temporal derivative are calculated analytically.\label{f.T2env}}
\end{figure}
...
%     \end{overpic}}
%     \put(0,0){
%     \begin{overpic}[width=14cm,trim=0cm 16.8cm 0.0cm 14mm, clip]{figures/2022-02-10d_Ldvar_Tvar_ThatVar_PARext_IA_vs_DA/0D-Highlat_wconst_lext_Ldvar_Tvar_CbasedIA_modular_24h_vs_0D-Highlat_wconst_lext_Ldvar_Tvar_CbasedDA_modular_24h_cont_abio1_1y.png}
%     \end{overpic}}
%     %\put(9,26){\scriptsize{\textsf{(a)}}}
%     %\put(69,26){\scriptsize{\textsf{(b)}}}
...
\begin{figure}[ht!]
\includegraphics[width=14cm,trim=0cm 11mm 0.0cm 5mm, clip]{figures/2022-02-10d_Ldvar_Tvar_ThatVar_PARext_IA_vs_DA/0D-Highlat_wconst_lext_Ldvar_Tvar_CbasedIA_modular_24h_vs_0D-Highlat_wconst_lext_Ldvar_Tvar_CbasedDA_modular_24h_cont_abio1_1y.png}
...
\subsection{T3: Comparing DA and IA variants in simulating in simulating multiple PFT's}
...
\begin{figure}[ht!]
\includegraphics[width=14cm,trim=0cm 11mm 0.0cm 5mm, clip]{figures/2022-02-13_Ldvar_Tvar_ThatVar_2P_PARext_IA_vs_DA/0D-Highlat_wconst_lext_Ldvar_Tvar_2P_CbasedIA_modular_24h_vs_0D-Highlat_wconst_lext_Ldvar_Tvar_2P_CbasedDA_modular_24h_cont_abio1_1y.png}

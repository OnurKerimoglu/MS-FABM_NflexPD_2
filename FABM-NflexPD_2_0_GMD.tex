...
\begin{flalign}
 ...
 \frac{\partial Z}{\partial \bar{I}} &= \frac{Q_\text{N,0} \cdot \alpha \cdot \hat{\theta}}{\hat{V}_\text{N} \cdot \text{DIN}} \left ( 1 - L_\text{I} \right) 
\end{flalign}
\onur{check: replacement of $\hat{\mu}_g$ (in S16, $\hat{\mu}^I$) with $\hat{\mu}_{net}$ may require revision of last equation}\\

...
\end{flalign}
with $m_{\text{C}}$ [\unit{m^3\ mmolC^{-1}\ d^{-1}}] being the C-based specific mortality rate.  The N counterpart, $F_{\text{Phy}_{\text{N}}-\text{Det}_{\text{N}}}$ is found by multiplying this term by $Q_{\text{N}}$ (see also Appendix~\ref{S:appQ4loss}).
...
The temperature-derivative of $Q_{\text{N}}$ is obtained via the derivatives of $Z$ with respect to $\hat{\mu}_{0}$, $\hat{V}_{0}$ and $R^{\text{Chl}}$:
\begin{flalign}
  \begin{split}
    \frac{\partial Q_{\text{N}}}{\partial T} &= \frac{\partial Q_{\text{N}}}{\partial Z} \frac{\partial Z}{\partial T}
    = \frac{\partial Q_{\text{N}}}{\partial Z} \left[ \frac{\partial Z}{\partial \hat{\mu}_{\text{net}}}
      ...
      + \frac{\partial Z}{\partial \hat{V}_{\text{N}}} \frac{\partial \hat{V}_{\text{N}}}{\partial \hat{V}_{0}} \frac{\partial \hat{V}_{0}}{\partial T} \right] \\ &
    = \frac{\partial Q_{\text{N}}}{\partial Z} \left[ \frac{\partial Z}{\partial \hat{\mu}_{\text{net}}}

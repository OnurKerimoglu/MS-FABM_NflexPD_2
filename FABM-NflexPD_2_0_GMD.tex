...
\end{flalign}
and the time-derivative of $L_{\text{D}}$ is given in the appendix.  Note that $\partial{\hat{\mu}_{\text{net}}} / \partial \hat{\theta} = 0$ by definition and is therefor not needed.
